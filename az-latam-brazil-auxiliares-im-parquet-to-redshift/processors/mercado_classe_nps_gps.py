...
def process(s3, file_key):
    ...
    redshift = {
        ...
        'table': 'aux_mercado_classe_nps_gps_tb'
    }
    ...
    try:
        ...
        ## Criando a tabela
        sql = f'CREATE TABLE IF NOT EXISTS {constants.rs_schema}.{redshift["table"]} (market_desc varchar(255), bu varchar(255), pack_cd varchar(255), load_data timestamp)'
        engine.execute(sql)
